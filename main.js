...
resultDiv.innerHTML = '';
resultDiv.className = 'mt-5 p-4 rounded-lg min-h-16 flex justify-center items-center flex-col';
...
console.log('Всего попыток:', attempts.length);
    ...
    if(bulls === 4){
        ...
        resultDiv.className = 'mt-5 p-4 rounded-lg min-h-16 flex justify-center items-center flex-col bg-white';
...
function updateCheckButton(){
    const allFilled = Array.from(digitInputs).every(input => input.value !== '');
